...
<html lang="en">
    ...
    <body id="page-top">
                                            ...
                                            <div class="col auto">
                                                ...
                                                <div class="h5 mb-0 font-weight-bold text-gray-900">
                                                    <?php  
                                                        ...
                                                        $sql = "SELECT SUM(TotalDue) as total from fakta_sales JOIN waktu ON fakta_sales.waktu_id=waktu.waktu_id";
                            ...
                            <div class="col-xl-3 col-md-6 mb-4">
                                <div class="card border-left-success shadow h-100 py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col auto">
                                                <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Total kuantitas barang</div>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                    <?php
                                                        $sql = "SELECT SUM(fakta_sales.OrderQty) total, waktu.tahun FROM fakta_sales JOIN waktu ON fakta_sales.waktu_id = waktu.waktu_id;";
                                                        $query = mysqli_query($mysqli,$sql);
                                                        while($row2=mysqli_fetch_array($query)){
                            ...
                            <!-- <div class="col-xl-3 col-md-6 mb-4">
                                <div class="card border-left-danger shadow h-100 py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col auto">
                                                <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">Total Incomes berdasarkan kategori Bikes</div>
                                                <div class="h5 mb-0 font-weight-bold text-gray-900">
                                                    <?php  
                                                        $mysqli = mysqli_connect("localhost","root","","whadventureworks");
                                                        $sql = "SELECT SUM(fakta_sales.TotalDue) total from fakta_sales JOIN produk ON fakta_sales.ProductID=produk.ProductID where produk.kategori = 'Bikes';";
                                                        $query = mysqli_query($mysqli,$sql);
                                                        while($row2=mysqli_fetch_array($query)){
                                                            echo "$".number_format($row2['total']);
                                                        }
                                            ...
                                            <div class="col-auto">
                                                <i class="fas fa-bicycle fa-2x text-gray-400"></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <!-- <div class="col-xl-8 col-lg-7">
                                <div class="card shadow mb-4"> -->
                                    ...
                                    <!-- <div
                                        class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                        <h6 class="m-0 font-weight-bold text-primary">Trend Pendapatan Penjualan Setiap Bulan</h6>
                                    </div> -->
                                    <!-- Card Body -->
                                    <!-- <div class="card-body">
                                        <div class="chart-area">
                                    ...
                                    <div class="card-body-store">
                                        <div class="chart-area-store">
                                            ...
                                            <?php
                                                ...
                                                $tahun = mysqli_query($mysqli,"SELECT DISTINCT(waktu.tahun) as tahun FROM fakta_sales JOIN waktu on waktu.waktu_id = fakta_sales.waktu_id");
                                                while($row = mysqli_fetch_array($tahun)){
                                                    $jenis_tahun[] = $row['tahun'];

                                                    $query = mysqli_query($mysqli,"SELECT SUM(fakta_sales.TotalDue) as amount FROM fakta_sales JOIN waktu ON fakta_sales.waktu_id = waktu.waktu_id WHERE waktu.tahun='".$row['tahun']."'");
        ...
        <script type="text/javascript">
            ...
            $amount = "SELECT SUM(sf.sub_total) as amount FROM sales_fact sf JOIN time t ON sf.time_id = t.time_id GROUP BY t.tahun";
            $i=1;
        ...
        <script type="text/javascript">
            ...
            $conn= mysqli_connect($host, $user, $password, $database);
            $year = "SELECT DISTINCT(t.tahun) as year FROM sales_fact sf JOIN time t on t.time_id = sf.time_id";
            $amount1= "SELECT SUM(sf.order_qty) as amountqty FROM sales_fact sf JOIN time t ON sf.time_id = t.time_id GROUP BY t.tahun";
            $i=1;
            $query_year=mysqli_query($conn, $year);
            $jumlah_year = mysqli_num_rows($query_year);
            $chart_year="";
