                                        ...
                                        <div class="col auto">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-900">
                                                <?php  
                                                    ...
                                                    $sql = "SELECT SUM(TotalDue) as total from fakta_sales";
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-warning shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Total Promo</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-900">
                                                <?php
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-900">
                                                <?php
                                                    $sql = "SELECT COUNT(ContactID) as jumlah_transaksi from fakta_sales";
                                                    $query = mysqli_query($mysqli,$sql);
                                                        while($row2=mysqli_fetch_array($query)){
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-900">
                                                <?php
                                                    $sql = "SELECT COUNT(shipmentfact_id) as jumlah_pengiriman from shipment_fact";
                                                    $query = mysqli_query($mysqli,$sql);
                                                        while($row2=mysqli_fetch_array($query)){
                    ...
                    <!-- Content Row 2 OLAP -->
                     ...
                     <div class="card shadow mb-4">
                            ...
                            <div class="collapse" id="collapseCardExample">
                                <div class="card-body">
                                    <iframe name="mondrian" src="http://localhost:8080/mondrian/testpage.jsp?query=whadventure" style="height: 500px;; width:100%; border:none; align-content:center"> </iframe>
                                </div>
                            </div>
                    </div>
