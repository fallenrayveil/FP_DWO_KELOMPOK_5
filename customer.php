...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                    ...
                    <div class="sidebar-brand-text mx-3">ADW</div>
                </a>
                                        ...
                                        <div class="row no-gutters align-items-center">
                                            <div class="col auto">
                                                ...
                                                <div class="h5 mb-0 font-weight-bold text-gray-900">
                                                    <?php  
                                                        $mysqli = mysqli_connect("localhost","root","","whadventureworks");
                                                        $sql = "SELECT COUNT(ContactID) as jumlah_cus from customer";
                                        ...
                                        <div class="row no-gutters align-items-center">
                                            <div class="col auto">
                                                ...
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                    <?php
                                                        $mysqli = mysqli_connect("localhost","root","","whadventureworks");
                                                        $sql = "SELECT COUNT(DISTINCT(fakta_sales.ContactID)) as customer FROM fakta_sales JOIN waktu ON fakta_sales.waktu_id = waktu.waktu_id WHERE waktu.tahun=2001";
                                                        $query = mysqli_query($mysqli,$sql);
                                                        while($row2=mysqli_fetch_array($query)){
                            ...
                            <div class="col-xl-3 col-md-6 mb-4">
                                <div class="card border-left-warning shadow h-100 py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col auto">
                                                <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Jumlah belanja</div>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                    <?php
                                                        $sql = "SELECT SUM(TotalDue) as sum FROM fakta_sales";
                                                        $query = mysqli_query($mysqli,$sql);
                                                        while($row2=mysqli_fetch_array($query)){
                ...
                <footer class="sticky-footer bg-white">
                    <div class="container my-auto">
                        <div class="copyright text-center my-auto">
                            <span>Copyright &copy; AdventureWorks</span>
                        </div>
                    </div>
                </footer>
                <!-- End of Footer -->
        ...
        <script type="text/javascript">
            ...
            $user= "root";
            $password= "";
            $database= "whadventureworks";
            $conn= mysqli_connect($host, $user, $password, $database);
            $year = "SELECT DISTINCT(waktu.tahun) as tahun FROM fakta_sales JOIN waktu on waktu.waktu_id = fakta_sales.waktu_id";
            $customer = "SELECT COUNT(DISTINCT(fakta_sales.ContactID)) as customer FROM fakta_sales JOIN waktu on waktu.waktu_id = fakta_sales.waktu_id GROUP BY waktu.tahun";
            $i=1;
        ...
        <script type="text/javascript">
            ...
            $database= "whadventureworks";
            $conn= mysqli_connect($host, $user, $password, $database);
            $bulan = "SELECT MONTHNAME(waktu.tgllengkap) bulan FROM fakta_sales JOIN waktu ON fakta_sales.waktu_id = waktu.waktu_id GROUP BY waktu.bulan";
            $amount1 = "SELECT COUNT(DISTINCT(fakta_sales.ContactID)) as customer FROM fakta_sales JOIN waktu on waktu.waktu_id = fakta_sales.waktu_id WHERE waktu.tahun = 2004 GROUP BY waktu.bulan";
            $amount2 = "SELECT COUNT(DISTINCT(fakta_sales.ContactID)) as customer FROM fakta_sales JOIN waktu on waktu.waktu_id = fakta_sales.waktu_id WHERE waktu.tahun = 2003 GROUP BY waktu.bulan";
            $amount3 = "SELECT COUNT(DISTINCT(fakta_sales.ContactID)) as customer FROM fakta_sales JOIN waktu on waktu.waktu_id = fakta_sales.waktu_id WHERE waktu.tahun = 2002 GROUP BY waktu.bulan";
            $i=1;
