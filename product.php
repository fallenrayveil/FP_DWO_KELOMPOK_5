                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                                            ...
                                            <div class="col mr-2">
                                                ...
                                                <div class="h5 mb-0 font-weight-bold text-gray-900">
                                                    <?php
                                                        ...
                                                        $sql = "SELECT COUNT(ProductID) as jumlah_produk from produk";
                            ...
                            <!-- Total Product Sub Category Card -->
                            <div class="col-xl-3 col-md-6 mb-4">
                                        ...
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                ...
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                    <?php
                                                        $sql = "SELECT COUNT(DISTINCT(SubKategori)) subkategori FROM produk";
                                                        $query = mysqli_query($mysqli,$sql);
                                                        while($row2=mysqli_fetch_array($query)){
                                                            echo number_format($row2['subkategori'],0,".",",");
                                                        }
                                                    ?>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                ...
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                    <?php
                                                        $sql = "SELECT COUNT(DISTINCT(kategori)) kategori FROM produk";
                                                        $query = mysqli_query($mysqli,$sql);
                                                        while($row2=mysqli_fetch_array($query)){
                            ...
                            <!-- <div class="col-xl-3 col-md-6 mb-4">
                                <div class="card border-left-warning shadow h-100 py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Total Vendor Produk</div>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                    <?php
                                                        $sql = "SELECT COUNT(DISTINCT(vendor)) vendor FROM product";
                                                        $query = mysqli_query($mysqli,$sql);
                                                        while($row2=mysqli_fetch_array($query)){
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body-store">
                                        <div class="chart-area-store">
                                            ...
                                            <?php
                                                $mysqli = mysqli_connect("localhost", "root", "", "whadventureworks");
                                                $vendor = mysqli_query($mysqli,"SELECT SUM(fakta_sales.OrderQty) as total, produk.kategori as category FROM fakta_sales JOIN produk ON fakta_sales.ProductID = produk.ProductID GROUP BY kategori");
                                                while($row = mysqli_fetch_array($vendor)){
                                                    $jenis_vendor[] = $row['category'];

                                                    $query = mysqli_query($mysqli,"SELECT SUM(fakta_sales.OrderQty) as total, produk.kategori as category FROM fakta_sales JOIN produk ON fakta_sales.ProductID = produk.ProductID GROUP BY kategori HAVING produk.kategori='".$row['category']."'");
